...
# Register container service provider (it is still in beta)
az provider register -n Microsoft.ContainerService

# Create a new resource group for our cluster management service
az group create \
    --name "com.oleksiionsoftware" \
    --location eastus

# Create a new managed Kubernetes cluster with 1 node
az aks create \
    --resource-group "com.oleksiionsoftware" \
    --name "oleksiionsoftware" \
    --node-count 1 \
    --generate-ssh-keys
